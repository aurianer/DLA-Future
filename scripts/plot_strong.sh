...
# Variables to modify:
debug=0
python_venv_path="$SCRATCH/virtual_envs/dlaf-benchmarks"
...
base_paths=(
    "$SCRATCH/benchmarks/dlaf-benchmarks/18-10-2024_14-32-53-stdexec-mimalloc-gpu" \
    "$SCRATCH/benchmarks/dlaf-benchmarks/18-10-2024_14-32-53-nostdexec-mimalloc-gpu" \
    )
# Path where you want your plotting results
out_path="$SCRATCH/benchmarks/dlaf-benchmarks/plots/18-10-2024_14-32-53"
####################################################################################################
